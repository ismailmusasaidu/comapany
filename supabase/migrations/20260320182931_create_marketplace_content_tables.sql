...
DROP POLICY IF EXISTS "Allow public read access to marketplace hero" ON marketplace_hero;
CREATE POLICY "Allow public read access to marketplace hero"
  ON marketplace_hero FOR SELECT TO anon, authenticated USING (true);

DROP POLICY IF EXISTS "Allow authenticated users to update marketplace hero" ON marketplace_hero;
...
DROP POLICY IF EXISTS "Allow authenticated users to insert marketplace hero" ON marketplace_hero;
...
DROP POLICY IF EXISTS "Allow public read access to marketplace categories" ON marketplace_categories;
CREATE POLICY "Allow public read access to marketplace categories"
  ON marketplace_categories FOR SELECT TO anon, authenticated USING (true);

DROP POLICY IF EXISTS "Allow authenticated users to manage marketplace categories" ON marketplace_categories;
...
DROP POLICY IF EXISTS "Allow public read access to marketplace featured products" ON marketplace_featured_products;
CREATE POLICY "Allow public read access to marketplace featured products"
  ON marketplace_featured_products FOR SELECT TO anon, authenticated USING (true);

DROP POLICY IF EXISTS "Allow authenticated users to manage marketplace featured products" ON marketplace_featured_products;
...
DROP POLICY IF EXISTS "Allow public read access to marketplace partners" ON marketplace_partners;
CREATE POLICY "Allow public read access to marketplace partners"
  ON marketplace_partners FOR SELECT TO anon, authenticated USING (true);

DROP POLICY IF EXISTS "Allow authenticated users to manage marketplace partners" ON marketplace_partners;
