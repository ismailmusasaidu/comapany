/*
  ...
  1. Data Seeding
    ...
    - Insert marketplace featured products
    - Insert marketplace partners

  Note: This migration seeds initial data for all content sections. Uses IF NOT EXISTS checks to avoid duplicates.
*/
