      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold text-gray-900">Messages from Admin</h1>
          </div>
        </div>
      </header>
            ...
            {activeThread ? (
              <>
                <div className="px-6 py-4 border-b border-gray-100">
                  <p className="font-bold text-gray-900">{activeThread.subject}</p>
                ...
                <div className="px-4 py-3 border-t border-gray-100">
                  <div className="flex items-end gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-3 rounded-xl text-sm font-semibold hover:from-blue-700 hover:to-blue-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
