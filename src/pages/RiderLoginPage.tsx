    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-950 to-slate-900 flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to your rider account</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          {unverified && (
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-5">
              ...
              {resendDone ? (
                ...
                <button onClick={handleResend} disabled={resendLoading || !email} className="text-sm font-semibold text-green-600 hover:text-green-700 underline underline-offset-2 disabled:opacity-50">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm transition-all"
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link to="/auth/forgot-password?portal=rider" className="text-xs text-green-600 hover:text-green-700 font-medium">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm transition-all"
                />
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/rider/register" className="text-green-600 hover:text-green-700 font-semibold">Apply as Rider</Link>
            </p>
          </div>
        </div>
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          Are you an admin?{' '}
          <Link to="/admin/login" className="text-gray-400 hover:text-white underline transition-colors">Admin login</Link>
        </p>
      </div>
    </div>
  );
