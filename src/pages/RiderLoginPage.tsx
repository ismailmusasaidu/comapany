    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-orange-950 flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to your rider dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          {unverified && (
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-5">
              ...
              <p className="text-amber-700 text-sm mb-3">Please verify your email before signing in.</p>
              {resendDone ? (
                ...
                <button onClick={handleResend} disabled={resendLoading || !email}
                  className="text-sm font-semibold text-orange-600 hover:text-orange-700 underline underline-offset-2 disabled:opacity-50">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" required value={email} onChange={e => setEmail(e.target.value)} placeholder="rider@email.com"
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link to="/auth/forgot-password?portal=rider" className="text-xs text-orange-500 hover:text-orange-600 font-medium">Forgot password?</Link>
              </div>
              <div className="relative">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link to="/rider/register" className="text-orange-500 hover:text-orange-600 font-semibold">Register as Rider</Link>
            </p>
          </div>
        </div>
