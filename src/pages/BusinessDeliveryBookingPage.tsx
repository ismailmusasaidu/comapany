...
export default function BusinessDeliveryBookingPage() {
  ...
  const [form, setForm, clearForm] = usePersistentState<BookingForm>('business_booking_form', EMPTY);
  const [step, setStep, clearStep] = usePersistentState<number>('business_booking_step', 1);
